...
$(npm bin)/gulp ngxfileuploader:build-release:clean
...
OPTS=(
  ...
  "--js_module_root=dist/releases/ngxfileuploader"
  ...
  dist/releases/ngxfileuploader/@uniprank/ngx-file-uploader.js
  dist/releases/cdk/@uniprank/cdk.js
