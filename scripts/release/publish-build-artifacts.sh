...
# ngxfileuploader packages that need to published.
PACKAGES=(cdk ngxfileuploader)
REPOSITORIES=(cdk-builds ngxfileuploader-builds)
...
publishPackage() {
  ...
  repoUrl="https://github.com/uniprank/${packageRepo}.git"
