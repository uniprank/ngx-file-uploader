...
# Publish ngxfileuploader docs assets to the ngxfileuploader-docs-content repo
# material.angular.io will pull from this assets repo to get the latest docs

cd "$(dirname $0)/../../"

docsPath="./dist/docs"
packagePath="./dist/releases/ngxfileuploader-examples"
repoPath="/tmp/ngxfileuploader-docs-content"
repoUrl="https://github.com/angular/ngxfileuploader-docs-content"
