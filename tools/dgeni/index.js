...
// Package definition for ngxfileuploader api docs. This only *defines* the package- it does not yet
...
let apiDocsPackage = new DgeniPackage('ngxfileuploader-api-docs', dgeniPackageDeps)
